                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                                ...
                                <div class="row align-items-center my-3">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="d-flex justify-content-between flex-wrap align-items-center">
                                            ...
                                            <a class="hyperlink hyperlink--primary text--sm" href="#">See Calendar</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="d-flex justify-content-between flex-wrap">
                                            ...
                                            <div class="ct-btn-group mt-2">
                                                <a class="btn btn--success btn--sm" href="#">Pay Now</a>
                                                <a class="btn btn--primary btn--sm" href="frequency-assignment.php">View Frequency Assignment</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <br>
                            <?php include("attachments-empty.php"); ?>
                        </div>
                    </div>
                </div>
            </div>
